...
<?php
	...
	$zerif_pricing_show = get_theme_mod('zerif_pricing_show');

	if( isset($zerif_pricing_show) && $zerif_pricing_show != 1 ):

	zerif_before_pricing_trigger();

		get_template_part( 'sections/pricing' );

	zerif_after_pricing_trigger();
