...
function zerif_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		/* our team show/hide */
		$wp_customize->add_setting( 'zerif_pricing_show', array(
			'sanitize_callback' => 'zerif_sanitize_checkbox',
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_pricing_show', array(
			'type' => 'checkbox',
			'label' => __('Hide pricing section?','zerif-lite'),
			'section' => 'zerif_pricing_section',
			'priority'    => 1,
		));

		/* our team title */
		$wp_customize->add_setting( 'zerif_pricing_title', array(
			'sanitize_callback' => 'zerif_sanitize_input',
			'default' => __('pricing','zerif-lite'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_pricing_title', array(
			'label'    => __( 'Title', 'zerif-lite' ),
			'section'  => 'zerif_pricing_section',
			'priority'    => 2,
		));
		...
		/* our team subtitle */
		$wp_customize->add_setting( 'zerif_pricing_subtitle', array(
			'sanitize_callback' => 'zerif_sanitize_input',
			'default' => __('Prove that you have real people working for you, with some nice looking profile pictures and links to social media.','zerif-lite'),'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_pricing_subtitle', array(
			'label'    => __( 'pricing subtitle', 'zerif-lite' ),
			'section'  => 'zerif_pricing_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_section( 'zerif_pricing_section' , array(
			'title'       => __( 'pricing section', 'zerif-lite' ),
			'priority'    => 35,
			'description' => __( 'The main content of this section is customizable in: Dashboard -> Appearance -> Widgets -> Our pricing section. There you must add the "Zerif - pricing member widget"', 'zerif-lite' )
		));
		...
		$wp_customize->add_setting( 'zerif_pricing_title', array(
			'sanitize_callback' => 'zerif_sanitize_input',
			'default' => __('YOUR pricing','zerif-lite'),
			'transport' => 'postMessage'
		));
		...
		$wp_customize->add_control( 'zerif_pricing_subtitle', array(
			'label'    => __( 'Our pricing subtitle', 'zerif-lite' ),
			'section'  => 'zerif_pricing_section',
			'priority'    => 3,
		));
