...
function zerif_setup() {
    ...
    add_image_size('zerif_pricing_photo', 174, 174, true);
	...
	add_action( 'zerif_pricing_header_title', 'zerif_pricing_header_title_function' ); #Outputs the title in Our team section
	add_action( 'zerif_pricing_header_subtitle', 'zerif_pricing_header_subtitle_function' ); #Outputs the subtitle in Our team section
...
function zerif_register_widgets() {
    ...
    register_widget('zerif_team_widget');
		register_widget('zerif_pricing_widget');


	$zerif_lite_sidebars = array ( 'sidebar-ourfocus' => 'sidebar-ourfocus', 'sidebar-testimonials' => 'sidebar-testimonials', 'sidebar-ourteam' => 'sidebar-ourteam', 'sidebar-pricing' => 'sidebar-pricing');
	...
	foreach ( $zerif_lite_sidebars as $zerif_lite_sidebar ):
		...
		elseif( $zerif_lite_sidebar == 'sidebar-pricing' ):

				$zerif_lite_name = __('pricing section widgets', 'zerif-lite');
 ...
 */
if ( empty ( $active_widgets[ $zerif_lite_sidebars['sidebar-pricing'] ] ) ):

    $zerif_lite_counter = 1;

    /* our team widget #1 */
    $active_widgets[ 'sidebar-pricing' ][0] = 'zerif_pricing-widget-' . $zerif_lite_counter;
    $pricing_content[ $zerif_lite_counter ] = array ( 'name' => 'ASHLEY SIMMONS', 'position' => 'Project Manager', 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dapibus, eros at accumsan auctor, felis eros condimentum quam, non porttitor est urna vel neque', 'fb_link' => '#', 'tw_link' => '#', 'bh_link' => '#', 'db_link' => '#', 'ln_link' => '#', 'image_uri' => get_template_directory_uri()."/images/team1.png" );
    update_option( 'widget_zerif_pricing-widget', $pricing_content );
    $zerif_lite_counter++;

    /* our team widget #2 */
    $active_widgets[ 'sidebar-pricing' ][] = 'zerif_pricing-widget-' . $zerif_lite_counter;
    $pricing_content[ $zerif_lite_counter ] = array ( 'name' => 'TIMOTHY SPRAY', 'position' => 'Art Director', 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dapibus, eros at accumsan auctor, felis eros condimentum quam, non porttitor est urna vel neque', 'fb_link' => '#', 'tw_link' => '#', 'bh_link' => '#', 'db_link' => '#', 'ln_link' => '#', 'image_uri' => get_template_directory_uri()."/images/team2p.png" );
    update_option( 'widget_zerif_pricing-widget', $pricing_content );
    $zerif_lite_counter++;

    /* our team widget #3 */
    $active_widgets[ 'sidebar-pricing' ][] = 'zerif_pricing-widget-' . $zerif_lite_counter;
    $pricing_content[ $zerif_lite_counter ] = array ( 'name' => 'TONYA GARCIA', 'position' => 'Account Manager', 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dapibus, eros at accumsan auctor, felis eros condimentum quam, non porttitor est urna vel neque', 'fb_link' => '#', 'tw_link' => '#', 'bh_link' => '#', 'db_link' => '#', 'ln_link' => '#', 'image_uri' => get_template_directory_uri()."/images/team3p.png" );
    update_option( 'widget_zerif_pricing-widget', $pricing_content );
    $zerif_lite_counter++;

    /* our team widget #4 */
    $active_widgets[ 'sidebar-pricing' ][] = 'zerif_pricing-widget-' . $zerif_lite_counter;
    $pricing_content[ $zerif_lite_counter ] = array ( 'name' => 'JASON LANE', 'position' => 'Business Development', 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dapibus, eros at accumsan auctor, felis eros condimentum quam, non porttitor est urna vel neque', 'fb_link' => '#', 'tw_link' => '#', 'bh_link' => '#', 'db_link' => '#', 'ln_link' => '#', 'image_uri' => get_template_directory_uri()."/images/team4o.png" );
    update_option( 'widget_zerif_pricing-widget', $pricing_content );
    $zerif_lite_counter++;
...
/****************************/
/****** pricing member widget **/
/***************************/

  class zerif_pricing_widget extends WP_Widget{

    	public function __construct() {
    		parent::__construct(
    			'zerif_pricing-widget',
    			__( 'Zerif - pricing member widget', 'zerif-lite' )
    		);
    		add_action('admin_enqueue_scripts', array($this, 'widget_scripts'));
    	}
    	...
    	function widget_scripts($hook) {
            if( $hook != 'widgets.php' )
                return;
    	    wp_enqueue_media();
            wp_enqueue_script('zerif_pricing_widget_script', get_template_directory_uri() . '/js/widget-pricing.js', false, '1.0', true);
        }
        ...
        function widget($args, $instance) {
            ...
            <div class="col-lg-3 col-sm-3  pricing-box">
                ...
                <div class="pricing-member">
    				...
    				<?php
    						...
    						$zerif_pricing_custom_media_id = wp_get_attachment_image_src($instance["custom_media_id"] );
    						if( !empty($zerif_pricing_custom_media_id) && !empty($zerif_pricing_custom_media_id[0]) ) {
    							?>

    								<figure class="profile-pic">

    									<img src="<?php echo esc_url($zerif_pricing_custom_media_id[0]); ?>" alt="<?php _e( 'Uploaded image', 'zerif-lite' ); ?>" />
                    ...
                    <div class="social-icons">
                        ...
                        <ul>
                            <?php
                                $zerif_pricing_target = '_self';
                                if( !empty($instance['open_new_window']) ):
                                    $zerif_pricing_target = '_blank';
                                endif;
                            ?>

                            <?php if ( !empty($instance['fb_link']) ): ?>
                                <li><a href="<?php echo apply_filters('widget_title', $instance['fb_link']); ?>" target="<?php echo $zerif_pricing_target; ?>"><i
                                            class="fa fa-facebook"></i></a></li>
                            <?php endif; ?>

                            <?php if ( !empty($instance['tw_link']) ): ?>
                                <li><a href="<?php echo apply_filters('widget_title', $instance['tw_link']); ?>" target="<?php echo $zerif_pricing_target; ?>"><i
                                            class="fa fa-twitter"></i></a></li>
                            <?php endif; ?>

                            <?php if ( !empty($instance['bh_link']) ): ?>
                                <li><a href="<?php echo apply_filters('widget_title', $instance['bh_link']); ?>" target="<?php echo $zerif_pricing_target; ?>"><i
                                            class="fa fa-behance"></i></a></li>
                            <?php endif; ?>

                            <?php if ( !empty($instance['db_link']) ): ?>
                                <li><a href="<?php echo apply_filters('widget_title', $instance['db_link']); ?>" target="<?php echo $zerif_pricing_target; ?>"><i
                                            class="fa fa-dribbble"></i></a></li>
                            <?php endif; ?>

    						<?php if ( !empty($instance['ln_link']) ): ?>
                                <li><a href="<?php echo apply_filters('widget_title', $instance['ln_link']); ?>" target="<?php echo $zerif_pricing_target; ?>"><i
                                            class="fa fa-linkedin"></i></a></li>
                            <?php endif; ?>
    ...
    function form($instance) {
        ...
        <p>
            ...
            if ( !empty($instance['image_uri']) ) :
                ...
                echo '<img class="custom_media_image_pricing" src="' . $instance['image_uri'] . '" style="margin:0;padding:0;max-width:100px;float:left;display:inline-block" alt="'.__( 'Uploaded image', 'zerif-lite' ).'" /><br />';
            ...
            <input type="text" class="widefat custom_media_url_pricing" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php if( !empty($instance['image_uri']) ): echo $instance['image_uri']; endif; ?>" style="margin-top:5px;">
            <input type="button" class="button button-primary custom_media_button_pricing" id="custom_media_button_clients" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php _e('Upload Image','zerif-lite'); ?>" style="margin-top:5px;">
        </p>
