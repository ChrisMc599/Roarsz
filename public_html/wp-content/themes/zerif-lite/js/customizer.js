...
( function( $ ) {
	...
	/* show/hide */
	wp.customize( 'zerif_pricing_show', function( value ) {
		value.bind( function( to ) {
			if ( '1' != to ) {
				$( 'section.pricing' ).css( {
					'display': 'block'
	...
	/* title */
	wp.customize( 'zerif_pricing_title', function( value ) {
		value.bind( function( to ) {
			if( to != '' ) {
				$( '#pricing .section-header h2' ).removeClass( 'zerif_hidden_if_not_customizer' );
			}
			else {
				$( '#pricing .section-header h2' ).addClass( 'zerif_hidden_if_not_customizer' );
			}
			$( '#pricing .section-header h2' ).html( to );
		} );
	} );

	/* subtitle */
	wp.customize( 'zerif_pricing_subtitle', function( value ) {
		value.bind( function( to ) {
			if( to != '' ) {
				$( '#pricing .section-header div.section-legend' ).removeClass( 'zerif_hidden_if_not_customizer' );
			}
			else {
				$( '#pricing .section-header div.section-legend' ).addClass( 'zerif_hidden_if_not_customizer' );
			}
			$( '#pricing .section-header div.section-legend' ).html( to );
		} );
	} );
